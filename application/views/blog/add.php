    ...
    <div class="container2">
        ...
        <form class="blogForm2" method="post" enctype="multipart/form-data">
            ...
            <div class="formGroup2">
                ...
                <input type="text" id="postTitle2" class="inputBox2" placeholder="Enter post title">
            </div>
            ...
            <div class="formGroup2">
                ...
                <div id="postContent2" class="textareaBox2" contenteditable="true" placeholder="Start typing..."></div>
            </div>

            <!-- Categories -->
            <div class="formGroup2">
                <label class="formLabel2">Categories</label>
                <div id="categoryList2" class="checkboxGroup2"></div>
            </div>
